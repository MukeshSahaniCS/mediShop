        ...
        >
          <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
            ...
            >
              © 2023 mediShop —
              <a
                href="https://twitter.com/MukeshSahani108"
            ...
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
              <a
                href="https://www.facebook.com/profile.php?id=100067802891234"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/itmukesh_108/"
                target="_blank"
                className="ml-3 text-gray-500"
              >
                <svg
              ...
              <a
                href="https://www.linkedin.com/in/mukesh-sahani-191679248/"
                target="_blank"
                className="ml-3 text-gray-500"
              >
                <svg
